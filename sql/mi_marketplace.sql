...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2024 a las 09:07:25
...
(5, 'Producto 1', 'Descripción del Producto 1', 19.99, 1, '2024-11-04 00:42:02'),
(6, 'Producto 2', 'Descripción del Producto 2', 29.99, 2, '2024-11-04 00:42:02'),
(12, 'Producto 3', 'Descripción del Producto 3', 15.99, 1, '2024-11-04 02:03:48');
...
(1, 'Juan Perez', 'juan.perez@example.com', 'hashed_password1', '2024-11-03 21:31:43'),
(2, 'Maria Lopez', 'maria.lopez@example.com', 'hashed_password2', '2024-11-03 21:31:43');
...
--
ALTER TABLE `orden_producto`
  ADD CONSTRAINT `orden_producto_ibfk_1` FOREIGN KEY (`orden_id`) REFERENCES `ordenes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `orden_producto_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE;
